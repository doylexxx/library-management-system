...
namespace LibraryManagementSystem
{
    public partial class bookBorrow : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(string.Format("You can only borrow {0} books! ",LibraryDB.MaxBorrow));
            }
            ...
            {
                bool flag = ldb.Borrow(textID.Text, textbno.Text);
                refreshlistview();
                if(flag)
        ...
        {
            MessageBox.Show(ldb.LastExecuted);
        }
